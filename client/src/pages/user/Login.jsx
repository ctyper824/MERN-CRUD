                    ...
                    <div className='max-w-[450px] h-auto mx-auto bg-black/75 text-white rounded-3xl'>
                        <div className='max-w-[320px] mx-auto py-16'>
                            ...
                            <form onSubmit={handleSubmit} className='w-full flex flex-col py-4'>
                                <input onChange={(e) => setEmail(e.target.value)} className='p-3 my-2 dark:bg-gray-800 rounded' type="email" placeholder='Email' autoComplete='email' />
                                ...
                                }
                                {
                                    ...
                                    </svg>Loading</button> : <button className='bg-amber-600 py-3 my-3 rounded font-bold'>Login</button>
                                }
                                <p className='py-10'><span className='text-gray-400'>New user?</span>{" "}
